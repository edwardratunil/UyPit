  ...
  return (
    <HelmetProvider>
      ...
      <div className="h-[91vh] overflow-auto bg-white text-black">
        ...
        <div className="mx-auto -mt-16 w-32 h-32 rounded-full border-4 overflow-hidden bg-slate-100 text-black border-gray-200">
        ...
        {/* Header */}
        <div className="py-4 shadow-md mt-10 w-[39rem] mx-auto rounded-xl bg-gray-100 text-black">
          <div className="flex justify-between items-center px-4 md:px-10">
            <div className="flex space-x-4 bg-gray-100 text-black">
              <button
                className={`px-3 py-2 font-bold text-base transition ${openTab === 1 ? 'text-gray-600 border-b-2 border-gray-600' : ' hover:text-gray-600'} text-black`}
                onClick={() => handleTabClick(1)}
              >
                Posts
              </button>
              <button
                className={`px-3 py-2 font-bold text-base transition ${openTab === 2 ? 'text-gray-600 border-b-2 border-gray-600' : ' hover:text-gray-600'}`}
        ...
        {openTab === 1 && (
          <div className="justify-center items-center flex flex-col md:flex-row mt-2">
            <div className="col-span-2 space-y-4 w-[50rem]">
              {posts.length > 0 ? (
                posts.map(post => (
                  <div key={post.id} className="mb-4 p-4 rounded-xl mt-4 mx-auto w-[39rem] shadow-md bg-gray-100 text-black">
                    <div className="flex justify-between items-center mb-4">
                      <div className="text-sm mb-5">
                        <p className="font-bold text-lg text-black">{`${user.first_name} ${user.last_name}`}</p>
                    ...
                    <div className="flex space-x-2 mt-2">
                      <button
                        ...
                        className="py-1 px-2 bg-gray-600 hover:bg-gray-700 rounded-xl text-white ml-auto"
                      >
                        View Post
                      </button>
                    </div>
                    <div className="mt-4 space-y-2">
                      {(post.comments || []).map((comment) => (
                        <div key={comment.id} className="p-2 bg-gray-200 rounded-xl">
                ...
                <p className="text-gray-700 flex items-center justify-center font-extrabold mt-20">No posts found</p>
              )}
        ...
        {openTab === 2 && (
          <div className="justify-center flex flex-col md:flex-row mt-2 ml-[0rem]">
            <div className="col-span-2 space-y-4 w-[50rem]">
              <ul className="divide-y mx-auto w-[39rem] rounded-xl mt-3 py-2 px-3 shadow-md bg-gray-100 text-black">
