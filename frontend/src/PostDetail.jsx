...
const PostDetail = () => {
  ...
  return (
    <HelmetProvider>
      ...
      <button
        onClick={handleBack}
        className="flex items-center mb-4 mt-2 ml-4 py-2 px-2 rounded-full bg-white text-black hover:bg-gray-200"
      >
        <FaArrowLeft className=" text-gray-400 w-5 h-5" />
      </button>

      <div className="flex-1 flex flex-col mt-0 overflow-y-auto bg-white text-black">
        <div className="flex flex-row justify-center">
          <div className="col-span-2 w-[50rem]">
            <div className="justify-center flex bg-white text-black">
              <div>
                <div className="p-4 rounded-xl mx-auto w-[40rem] shadow-md bg-gray-100 text-black">
                  <div className="items-center mb-2 flex mt-1">
                    ...
                    <div className="text-sm mb-5">
                      <p className="font-bold text-lg text-black"> {post.user.first_name} {post.user.last_name}</p> 
                      <p className="text-xs text-gray-500"> {moment(post.created_at).format('MMMM Do YYYY @ h:mm A')}</p>
                    </div>
                          ...
                          <ul className="text-sm text-gray-700 w-28 items-center">
                            <li>
                              <a href='#'
                                ...
                                className="px-2 py-2 hover:bg-gray-200 p-2 flex items-center mb-2 relative"
                              >
                                Edit
                              </a>
                            </li>
                  ...
                  {editingPost ? (
                    <div>
                      <input
                        ...
                        className="w-full h-32 px-3 py-2 bg-gray-200 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500"
                      />
                  ...
                  <div className="flex space-x-2 mt-2">
                    ...
                    >
                      {post.liked ? (
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10 fill-red-600 stroke-red-600 hover:bg-red-200 rounded-full px-2 py-1">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
                        </svg>
                      ) : (
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-10 stroke-gray-500 text-gray-200 hover:bg-gray-200 rounded-full px-2 py-1">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12Z" />
                        </svg>
                      )}
                    </button>
                  ...
                  <div className="mt-4 space-y-2">
                    {(post.comments || []).map((comment) => (
                      <div key={comment.id} className="p-2 comment border-t border-gray-500 bg-gray-200 rounded-md">
                          ...
                          <div className="flex space-x-2 ml-auto relative">
                            ...
                            {openCommentDropdowns[comment.id] && (
                              <div className="absolute top-full left-0 bg-white border border-gray-300 rounded-lg w-28 flex py-2">
                                <ul className="text-sm text-gray-700 w-28 items-center">
                                  <li>
                                    <a href="#" onClick={() => handleEditComment(comment.id, comment.content)} className="px-2 py-2 hover:bg-gray-200 p-2 flex items-center mb-2 relative">
                                      Edit
                                    </a>
                                  </li>
                                  <li>
                                    <a href="#" onClick={() => handleDeleteComment(comment.id, post.id)} className="px-2 py-2 hover:bg-gray-200 p-2 flex items-center mb-2 relative">
                                      Delete
                                    </a>
                                  </li>
                                </ul>
                        ...
                        {editingCommentId === comment.id ? (
                          <>
                            <input
                              ...
                              className="w-full h-20 px-3 py-2 bg-gray-200 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500 mt-2"
                            />
                            <div className="flex space-x-2 mt-2">
                              <button
                    ...
                    <div className="mt-4">
                      <form onSubmit={handleSubmitComment} className="flex items-center px-14">
                        <input
                          ...
                          className="py-1.5 rounded-lg justify-center px-32 focus:outline-none focus:ring-1 focus:ring-gray-500 focus:border-primary bg-gray-200 text-gray-700 placeholder:text-gray-500 pl-20 border border-gray-300"
                        />
                        <button
                          type="submit"
                          className="bg-gray-500 hover:bg-gray-600 ml-2 flex items-center justify-center rounded-xl bg-primary px-2 py-2 text-center text-base font-medium text-white"
                        >
                          Comment
                        </button>
                      </form>
