...
const Search = () => {
  ...
  return (
    <HelmetProvider>
      ...
      <div className="h-screen flex flex-row mx-auto bg-white text-black">
        ...
        <div className="mx-auto w-1/2 p-6 overflow-auto">
          ...
          {users.length > 0 ? (
            users.map((user) => (
              <div key={user.id} className="mb-4 px-5 py-5 w-full bg-gray-100 rounded-md shadow-md">
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    ...
                    <div>
                      <button onClick={() => handleViewProfile(user.id)} className="text-lg no-underline hover:underline font-semibold text-gray-900">
