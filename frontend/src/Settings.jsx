...
const Settings = () => {
  ...
  return (
    <HelmetProvider>
      ...
      <div className="w-full h-[91vh] flex flex-col md:flex-row bg-white text-black">
        <div className="flex flex-col lg:w-1/5 p-6 bg-white text-black">
          <h1 className="mb-8 text-2xl font-semibold">Settings</h1>
          <button
            className={`cursor-pointer text-left w-full mb-4 px-3 py-2 font-semibold transition ${openTab === 1 ? 'text-gray-500 border-l-2 border-gray-500' : 'text-dark hover:text-gray-500'}`}
            onClick={() => handleTabClick(1)}
          >
            Profile Picture
          </button>
          <button
            className={`cursor-pointer text-left w-full mb-4 px-3 py-2 font-semibold transition ${openTab === 2 ? 'text-gray-500 border-l-2 border-gray-500' : 'text-dark hover:text-gray-500'}`}
            onClick={() => handleTabClick(2)}
          >
            Edit Profile
          </button>
          <button
            className={`cursor-pointer text-left w-full mb-4 px-3 py-2 font-semibold transition ${openTab === 3 ? 'text-gray-500 border-l-2 border-gray-500' : 'text-dark hover:text-gray-500'}`}
            ...
            <>
              {openTab === 1 && (
                <div>
                  ...
                  <div className="p-6 max-w-lg rounded-md bg-white text-black">
                    ...
                    <form onSubmit={handleProfileImageSubmit} className="mt-6 space-y-4">
                      <div className="flex flex-col">
                        <input
                          ...
                          className="w-[20rem] px-3 py-2 mt-1 mx-auto items-center border rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent bg-gray-200 text-black"
                        />
                        <div className="flex justify-center mt-4">
                          <button
                            type="submit"
                            className="px-4 py-2 ml-60 text-white bg-gray-500 rounded-md focus:outline-none hover:bg-gray-600"
                          >
                            Upload
                          </button>
                        </div>
              ...
              {openTab === 2 && (
                <div>
                  <div className="p-0 max-w-lg bg-white text-black">
                    ...
                    <form onSubmit={handleEditInfoSubmit} className="space-y-4 ml-16">
                      <div className="flex flex-col space-y-4">
                        ...
                        <input
                          ...
                          className="w-full px-3 py-2 bg-white border rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-transparent border-gray-300"
                        />
